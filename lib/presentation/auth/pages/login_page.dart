      ...
      body: ListView(
        ...
        children: [
          ...
          Padding(
              ...
              child: Image.asset(
                Assets.images.mumtazpreneur.path,
                width: 100,
                height: 100,
              )),
          ...
          BlocConsumer<LoginBloc, LoginState>(
            listener: (context, state) {
              state.maybeWhen(
                orElse: () {},
                success: (authLocalDatasource) {
                  // menyimpan ke ke lokal data
                  AuthLocalDatasource().saveAuthData(authLocalDatasource);
                  // menampilkan snackbar login sukses
                  ...
                  // pindah halaman ke dashboard page
