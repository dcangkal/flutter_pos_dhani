...
class CwbPrint {
  ...
  Future<List<int>> printOrder(
    ...
    bytes += generator.text('Mumtaz Preneur',
    ...
    bytes += generator.text('Banjarmasin No. 1',
    ...
    for (final product in products) {
      final totalPerItem = product.product.price * product.quantity;
      ...
      bytes += generator.row([
        PosColumn(
          text:
              '${product.product.price.currencyFormatRp} x ${product.quantity} pcs',
          width: 8,
          styles: const PosStyles(align: PosAlign.left),
        ),
        PosColumn(
          text: totalPerItem.currencyFormatRp,
          width: 4,
